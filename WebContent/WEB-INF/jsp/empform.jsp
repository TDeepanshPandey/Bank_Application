...
BANK</center>
  ...
  &#8226 &nbsp Deposit and Withdraw money anywhere&nbsp
	...
	<tr>
	<td style="background-color:#000033;"><a href="empform">Create Account</a></td>
	</tr>
	<tr>
...
<div class="trymsg" >
			<h1 style="font-weight:bold; color:#003366;" >Account Opening Form</h1><br>
       <form:form method="POST" action="save">  
         ...
         <tr>  
          <td style="color:white; font-size:24px;">Name  </td> 
          <td><form:input path="name"  /></td>
         </tr>  
         <tr>  
          <td style="color:white; font-size:24px;">Email-Id </td>  
          <td><form:input path="emailid" /></td>
         </tr> 
         <tr>  
          <td style="color:white; font-size:24px;padding-right:10px;">Account Type </td>  
          <td><form:select path="accounttype">
    		...
    		<form:option value="PF" label="PF" />
    		<form:option value="FD" label="FD" />   
</form:select></td>
         </tr> 
         <tr>
          <td style="color:white; font-size:24px;">Date of Birth </td>  
          <td><form:input path="dob" placeholder="DD/MM/YYYY"/></td>
         </tr> 
           <tr>
         <td style="color:white; font-size:24px;">Pan Number </td>  
          <td><form:input path="pannumber" /></td>
         </tr> 
           <tr>
          <td style="color:white; font-size:24px;">Address </td>  
          <td><form:input path="address" /></td>
         </tr>
           <tr> 
           
           <td style="color:white; font-size:24px;">Pin code </td>  
          <td><form:input path="pincode" /></td>
         </tr>
         
         
           <tr>
           <td style="color:white; font-size:24px;">Mobile </td>  
