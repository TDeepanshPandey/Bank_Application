...
<div class="indexheader">
 ...
 <div class="moving">
  ...
  &#8226 &nbsp Deposit and Withdraw money anywhere&nbsp
	...
	<div class="container">
	<div class="errortext">
	<p><h1 style="font-weight:bold; color:#003366;" >Sorry, You don't have enough privileges to do this.<br> Please contact Manager or DBA for the same <br></h1>
	<p><h1 style="font-weight:bold; color:#003366;" ><a href="index" style="text-decoration:none;"> Go Back </a></h1></p>
	</div>
	</div>
