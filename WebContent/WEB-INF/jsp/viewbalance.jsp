...
BANK</center>
  ...
  &#8226 &nbsp Deposit and Withdraw money anywhere&nbsp
	...
	<tr>
	<td style="background-color:#000033;"><a href="getbalance">Balance Enquiry</a></td>
	</tr>
	<tr>
...
<div class="trymsg" >
			<h1 style="font-weight:bold; color:#003366;" >Balance Enquiry </h1> <br>
           <c:forEach var="emp" items="${list}"> 
    
   <p style="font-weight:bold; font-size:20px; "> <br> <br> <br> Account Holder Name : ${emp.name}<br> Account Number : ${emp.accountid}<br> Current Account Balance : Rs. ${emp.balance}</p>
