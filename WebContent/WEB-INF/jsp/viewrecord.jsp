...
BANK</center>
  ...
  &#8226 &nbsp Deposit and Withdraw money anywhere&nbsp
	...
	<tr>
	<td style="background-color:#000033;"><a href="report">View Report</a></td>
	</tr>
	<tr>
...
<div class="trymsg" >
			<h1 style="font-weight:bold; color:#003366;" >Account Statement</h1><br>
        
       
	<table border="2" width="70%" cellpadding="2" style="width:700px;">
	<tr><th>Account  Number</th><th>Old Balance</th><th>New Balance</th><th>Transaction Type</th><th>Remarks</th></tr>
    <c:forEach var="emp" items="${list}"> 
    <tr>
    <td>${emp.accountid}</td>
    <td>${emp.oldbalance}</td>
    <td>${emp.newbalance}</td>
    <td>${emp.transtype}</td>
    <td>${emp.remarks}</td>
    </tr>
    </c:forEach>
